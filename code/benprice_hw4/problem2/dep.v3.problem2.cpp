...
int main()
{
    ...
    for (int x = 2; x < 513; ++x)
    {
        ...
        for (int t = 0; t < ntrials; ++t)
        {
            ...
            A_double = generateRandomMatrix<double>(m, p, -99.0, 99.0);
            B_double = generateRandomMatrix<double>(p, n, -99.0, 99.0);
            C_double = generateRandomMatrix<double>(m, n, -99.0, 99.0);
