...
int main()
{
    ...
    {
        std::vector<std::vector<int>> A{{-4, -5, 1, -4}, {-4, -1, -2, -4}, {-1, 0, -1, -1}, {4, -1, -5, -3}, {3, 2, 5, 0}};
        std::vector<std::vector<int>> B{{-2, 3, 5}, {5, -3, -1}, {5, -1, 5}, {-5, 1, -2}};
        std::vector<std::vector<int>> C{{2, -4, 1}, {2, -4, 4}, {0, 5, 2}, {2, -4, -3}, {2, -5, -1}};
